      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4">
        ...
        >
          <div className="flex flex-col space-y-3 py-4 border-t border-gray-800">
            ...
            <button 
              onClick={toggleLanguage}
              className="mx-4 px-4 py-3 bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg font-medium hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 text-center"
            >
              {i18n.language === 'en' ? 'FR' : 'EN'}
            </button>
          </div>
