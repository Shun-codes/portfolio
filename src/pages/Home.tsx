      ...
      <section className="min-h-[90vh] flex flex-col items-center justify-center text-center space-y-8 relative">
        ...
        <div className="relative z-10 space-y-6 px-2 sm:px-4">
          ...
          <div className="max-w-3xl mx-auto mt-6">
            <p
              className="text-gray-300 text-base sm:text-lg md:text-xl leading-relaxed mb-8 
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            {[
              ...
              >
                ...
                <p className="relative text-white font-bold text-center text-lg">
                  {skill.name}
                </p>
              </div>
            ))}
          ...
          <div className="text-center">
            ...
            >
              ...
              <img
                src="/icons/arrow-right-up-box-fill.svg"
                alt=""
